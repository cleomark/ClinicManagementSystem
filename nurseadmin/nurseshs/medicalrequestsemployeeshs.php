...
<html lang="en"> 
<head>
    <title>Employee Medical Requests</title>
	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">
                ...
                <div class="app-card app-card-notification shadow-sm mb-4">
                    ...
                    <?php
    $sql = "SELECT * FROM medical WHERE c_employee = 'Employee in SHS'";
    ...
    while ($row = $result->fetch_array()) {
     ...
     <?php if ($is_deleted_on_website == 0): ?>
        ...
        <div class="message">
            ...
            <a href="viewmedicalrequestsemployeeshs.php?date_created=<?php echo $row['date_created']; ?>">
