	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">
                ...
                <div class="app-card app-card-notification shadow-sm mb-4">
                    ...
                    <?php
    $sql = "SELECT * FROM physician WHERE role = 'Student in South Campus'";
    ...
    while ($row = $result->fetch_array()) {
     ...
     <?php if ($is_deleted_on_website == 0): ?>
        ...
        <div class="message">
            ...
            <?php if ($is_read == 0): ?>
                <a href="function/forphysiciancollegereadstudent.php?physician_id=<?php echo $physician_id; ?>">Mark as Read</a>
            <?php endif; ?>

            <a href="function/forphysiciancollegedeletestudent.php?physician_id=<?php echo $physician_id; ?>" onclick="return confirm('Are you sure you want to delete this message?')">Deleted</a>
