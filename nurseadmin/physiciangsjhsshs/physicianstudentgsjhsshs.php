...
<html lang="en"> 
<head>
    <title>Student Consultation Request</title>
    ...
    while ($row = $result->fetch_array()) {
     ...
     <?php if ($is_deleted_on_website == 0): ?>
        ...
        <div class="message">
            ...
            <?php if ($is_read == 0): ?>
                <a href="function/forphysiciangsjhsshsreadstudent.php?physician_id=<?php echo $physician_id; ?>">Mark as Read</a>
            <?php endif; ?>

            <a href="function/forphysiciangsjhsshsdeletestudent.php?physician_id=<?php echo $physician_id; ?>" onclick="return confirm('Are you sure you want to delete this message?')">Deleted</a>
            
            <a href="viewphysicianrequestgsjhsshs.php?date_created=<?php echo $row['date_created']; ?>">
