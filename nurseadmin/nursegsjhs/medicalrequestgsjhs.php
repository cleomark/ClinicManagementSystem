    ...
    while ($row = $result->fetch_array()) {
     ...
     <?php if ($is_deleted_on_website == 0): ?>
        ...
        <div class="message">
            ...
            <?php if ($is_read == 0): ?>
                <a href="function/formedicalgsjhsreadstudent.php?med_id=<?php echo $med_id; ?>">Mark as Read</a>
            <?php endif; ?>
            ...
            <a href="viewmedicalstudentrequest.php?date_created=<?php echo $row['date_created']; ?>">
